...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { to: "/kitchens", label: "Cloud Kitchens" },
  ];

  return (
    <>
      <div className="flex flex-row bg-black justify-between relative border-none px-6 lg:px-10">
        <div className="flex items-center">
          <p className="text-white font-extrabold cursor-pointer transition duration-300 hover:[text-shadow:0_0_10px_rgba(255,255,255,0.8),0_0_20px_rgba(255,255,255,0.6),0_0_30px_rgba(255,255,255,0.4)]">
            Eatelligence
          </p>
        </div>
